...
export function ChatInterface() {
  ...
  return (
    <div className="flex flex-col h-full bg-black/30 backdrop-blur-sm relative overflow-hidden" onDrop={handleDrop} onDragOver={handleDragOver} onDragLeave={handleDragLeave}>
      ...
      <div ref={messagesContainerRef} className={`overflow-y-auto relative z-10 aras-scroll max-h-[70vh] ${!hasMessages ? 'flex items-center justify-center flex-1' : 'px-6 pt-4 pb-6 space-y-4'}`}>
        {!hasMessages ? (
      ...
      {hasMessages && (
        <div className="px-4 pt-3 pb-2 border-t border-white/5 bg-black/20 backdrop-blur-sm mt-4">
          {uploadedFiles.length > 0 && (
          ...
          <div className="mt-0.5 pb-0.5 flex items-center justify-center gap-2 text-xs text-gray-500">
