...
export function ChatInterface() {
  ...
  return (
    <div className="flex flex-col h-full bg-black/30 backdrop-blur-sm relative overflow-hidden" onDrop={handleDrop} onDragOver={handleDragOver} onDragLeave={handleDragLeave}>
      ...
      <div ref={messagesContainerRef} className={`overflow-y-auto relative z-10 aras-scroll max-h-[60vh] ${!hasMessages ? 'flex items-center justify-center flex-1' : 'px-6 pt-4 pb-0 space-y-4'}`}>
        {!hasMessages ? (
      ...
      {hasMessages && (
        <div className="px-4 py-1 border-t border-white/5 bg-black/20 backdrop-blur-sm">
          {uploadedFiles.length > 0 && (
