...
export function ChatInterface() {
  ...
  return (
    <div className="flex flex-col h-full bg-black/30 backdrop-blur-sm relative overflow-hidden" onDrop={handleDrop} onDragOver={handleDragOver} onDragLeave={handleDragLeave}>
      ...
      <div ref={messagesContainerRef} className={`flex-1 overflow-y-auto relative z-10 aras-scroll ${!hasMessages ? 'flex items-center justify-center' : 'px-6 pt-4 pb-24 space-y-4'}`}>
        {!hasMessages ? (
      ...
      {hasMessages && (
        <div className="px-4 pt-1 pb-1 border-t border-white/5 bg-black/20 backdrop-blur-sm">
          {uploadedFiles.length > 0 && (
