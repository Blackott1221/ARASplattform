...
// ---------------------------------------------------------------------------
// b2venture — Pitch Deck Landing Page
// Route: /vc/b2venture
// ---------------------------------------------------------------------------
...
const TEN_PS = [
  { label: "Position", icon: Target, text: "Compliance-first voice platform for DACH → programmable Voice & Action layer for European enterprise." },
  { label: "People", icon: Users, text: "Founder-led execution; senior technical leadership; full commitment — all-in window." },
  { label: "Product", icon: Cpu, text: "Proprietary stack (LLM + voice + orchestration); enterprise reliability; compliance-by-design." },
  { label: "Price", icon: BarChart3, text: "Subscription + usage tiers; ROI measured in meetings, qualification, workload reduction." },
  { label: "Place", icon: Globe, text: "DACH first — privacy sensitivity + large B2B volume; regulated verticals early." },
  { label: "Process", icon: Layers, text: "Connect CRM / import leads → launch → qualify → log outcomes → iterate." },
  { label: "Performance", icon: TrendingUp, text: "Paid conversion, usage depth, escalation quality, meeting yield." },
  { label: "Plan", icon: Calendar, text: "2026 DACH GTM → 2027 SDK → 2028 marketplace → 2029/30 category leadership." },
  { label: "Purpose", icon: Shield, text: "Teams needing scalable outreach with trust + compliance constraints." },
  { label: "Potential", icon: Rocket, text: "Platform moat via SDK/marketplace + compliance primitives + enterprise deployment." },
];

const WHY_B2 = [
  {
    title: "Angel community = distribution",
    text: "b2venture's angel network accelerates intros into DACH enterprise + regulated verticals (finance, health, insurance) where sovereignty matters most.",
    icon: Network,
  },
  {
    title: "Pre-seed/seed DNA + long-term support",
    text: "Perfect partner for a 5-year platform build — from outbound wedge to SDK and marketplace. b2venture supports formation-to-scale.",
    icon: Rocket,
  },
  {
    title: "Thesis match: AI + B2B + Infra",
    text: "AI/ML + B2B SaaS + infra-grade reliability + compliance posture — directly aligned with b2venture's investment thesis.",
    icon: Shield,
  },
];

const TIMELINE = [
  { year: "2026", label: "DACH GTM Launch", desc: "Repeatable sales motion, enterprise logos, compliance certifications, angel-powered intros." },
  { year: "2027", label: "SDK & EU Expansion", desc: "Developer SDK, partner channels, expansion beyond DACH into EU markets." },
  { year: "2028", label: "Skills Marketplace", desc: "Third-party agent integrations, multi-vertical deployment, platform economics." },
  { year: "2029–30", label: "Category Leadership", desc: "European leader in enterprise voice AI infrastructure. Global positioning." },
];

export default function B2VenturePage() {
  useEffect(() => {
    document.title = "ARAS AI × b2venture — Swiss-built Voice & Action Infrastructure";
  }, []);
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-[90vh] flex items-center">
          <div className="max-w-6xl mx-auto px-6 py-24 w-full">
            ...
            >
              Swiss-built Voice & Action Infrastructure
            </motion.h1>
            ...
            >
              Proprietary LLM (ARAS Core) + own voice engine + orchestration layer —{" "}
              <span className="text-white font-semibold">Swiss/EU-first</span>, built for regulated enterprise in DACH.
            </motion.p>
            ...
            >
              DACH-first, enterprise-ready voice platform — amplified by{" "}
              <span className="text-[#e9d7c4] font-semibold">b2venture's angel-powered distribution</span> into the markets
              where trust and compliance decide who wins.
            </motion.p>
            ...
            >
              <a
                href="mailto:ai@aras-ai.com?subject=b2venture%20%E2%80%94%2020-min%20technical%20walkthrough"
        ...
        <section className="py-24">
          <div className="max-w-6xl mx-auto px-6">
            <AnimatedSection>
              ...
              <p className="text-gray-400 mb-12 max-w-2xl">Concrete thesis alignment — not generic VC pitch.</p>
            </AnimatedSection>
                ...
                <div className="grid md:grid-cols-2 gap-10">
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed mb-4">
                      ...
                      that turns voice into an API: connected to CRM, routing, follow-ups, and measurable outcomes.
                    </p>
                    <p className="text-sm text-gray-500">
                      Today: APIs/webhooks + integrations. Next: SDK (2027) → Skills Marketplace (2028).
                    </p>
                  </div>
                  <div className="space-y-4">
                    {[
                      { label: "Proprietary LLM (ARAS Core)", desc: "Trained for enterprise sales conversations" },
                      { label: "Real-time Voice Engine", desc: "Sub-200ms, human-grade prosody & turn-taking" },
                      { label: "Orchestration Layer", desc: "Qualification, routing, handoffs, follow-ups" },
                      { label: "Swiss/EU Infrastructure", desc: "GDPR-native, data sovereignty, audit-ready" },
                    ].map((item, i) => (
                      <motion.div
                        key={item.label}
        ...
        <section className="py-24">
          <div className="max-w-6xl mx-auto px-6">
            <AnimatedSection>
              ...
              <p className="text-gray-400 mb-12">b2venture lens — investor-grade snapshot.</p>
            </AnimatedSection>
            ...
            <AnimatedSection>
              <GlassCard className="p-8 md:p-12">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-300">
                      <li className="flex gap-2 items-start">
                        ...
                        Compliance + integrations (enterprise-ready)
                      </li>
                      <li className="flex gap-2 items-start">
                        <Zap className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: BRAND.orange }} />
                        DACH GTM (sales / partners / CS)
                      </li>
                      <li className="flex gap-2 items-start">
                        <Zap className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: BRAND.orange }} />
                ...
                <p className="text-gray-300 mb-8 text-lg">
                  Next step:{" "}
                  <span className="text-white font-semibold">20-minute technical walkthrough</span> + short discussion
                  on fund fit.
                </p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <AnimatedSection>
              <GlassCard className="p-8 text-center">
                ...
                <p className="text-gray-500 mb-6 text-sm">Download the b2venture version of the ARAS AI deck.</p>
                <a
                  href="#"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full font-bold text-sm uppercase tracking-wider transition-all hover:scale-[1.02]"
                  style={{
